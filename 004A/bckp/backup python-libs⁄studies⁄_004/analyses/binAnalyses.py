...
def binAnalyses(dm, dv, varToBin, factor, subjectID = "file",
	...
	# Plot:
	fig = plt.figure()
	figName = "004A: Effect size (%s - %s) as a function of binned %s - dv = %s trim = %s driftCorr = %s"\
...
def binAnalysesSepLines(dm, dv, varToBin, factor, subjectID = "file",
	...
	# Plot:
	fig = plt.figure()
	figName = "004A: %s as a function of %s and binned %s - trim = %s driftCorr = %s"\
...
def binAnalysesTwoFactors(dm, dv, varToBin, factor, subjectID = "file",
	...
	# Plot:
	fig = plt.figure()
	figName = "004A: Effect size (%s - %s) as a function of binned %s - trim = %s driftCorr = %s"\
