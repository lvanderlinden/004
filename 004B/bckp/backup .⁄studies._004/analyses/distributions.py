...
def distHist(dm, dv, nBin = 100, showFig = False, saveFig = True, \
	...
	if figName == None:
		figName = "Exp %s DistHist	%s nBin = %s cousineau = %s zTransform = %s trim = %s driftCorr = %s" %\
			(exp, dv, nBin, cousineau, zTransform, trim, driftCorr)
...
def distHistSplit(dm, dv, factor, nBin =50, showFig = False, saveFig = True, \
		...
		trim = True, figName = None, yLabel = None, xLabel = None):
	...
	if figName == None:
		figName = "Exp %s: DistHist %s split by %s nBin = %s cousineau = %s zTransform = %s trim = %s driftCorr = %s" %\
			(exp, dv, factor, nBin, cousineau, zTransform, trim, driftCorr)
	plt.suptitle(figName)
...
def distHistTwoVars(dm, dvList, nBin =50, showFig = False, saveFig = True, \
		cousineau=True, saveExt = ".jpg", zTransform = True, subjectID = "file",\
		trim = True, figName = None, xLabel = None, yLim = None, xLim = None):
	...
	if figName == None:
		figName = "Exp %s: DistHist %s and %s nBin = %s cousineau = %s zTransform = %s trim = %s driftCorr = %s" %\
			(exp, dvList[0], dvList[1], nBin, cousineau, zTransform, trim, driftCorr)
	plt.suptitle(figName)
