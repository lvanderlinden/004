...
#	
	for sacc in ["1", "2", "3"]:	
#	
		dm_sacc = onObject.onObject(dm, sacc, verbose = True)
		#dm_sacc = dm_sacc.selectByStdDev(["file"], "endX%sNormToHandle" % sacc)
#		
#		dm_sacc1 = dm.addField("cousineau")
#		dm_sacc1 = dm_sacc1.withinize("endX%sNormToHandle" % sacc, "cousineau", \
#			key = "file")
#		dm_sacc1 = dm_sacc1.selectByStdDev(["file"], "cousineau")
#		from matplotlib import pyplot as plt
#		plt.subplot(3,1,int(sacc))
##		plt.hist(dm_sacc1["endX2Norm"], bins = 100)
##		plt.subplot(212)
#		plt.hist(dm_sacc1["cousineau"], bins = 100)
#		plt.xlim(-.7, .7)
#
#	plt.show()
#	
